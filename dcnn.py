...
if __name__ == "__main__":
    ...
    # Create and train the DCNN model
    model = create_dcnn_model((features_array.shape[1], 1))

    with mlflow.start_run():
        mlflow.log_param("model_type", "DCNN with FFT Features")
        ...
        disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=["non guns", "guns"])
